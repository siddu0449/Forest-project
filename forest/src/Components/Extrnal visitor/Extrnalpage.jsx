...
export default function ExternalVisitor() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-b from-green-200 via-green-400 to-green-900">
      
      <div className="bg-white bg-opacity-90 p-4 rounded-lg shadow-lg w-full max-w-sm">
